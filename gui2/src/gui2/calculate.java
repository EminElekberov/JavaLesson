...
public class calculate extends JFrame {
	...
	public calculate() {
		...
		setTitle("hesab makines");
		setResizable(false);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 343, 383);
		...
		lbl.setBounds(0, 0, 307, 21);
		screen.add(lbl);
		
		JPanel control = new JPanel();
		control.setBounds(10, 91, 307, 252);
